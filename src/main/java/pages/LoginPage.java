...
public class LoginPage {
    ...
    private By operatorMobileNumber = By.xpath("//input[@placeholder='Enter mobile no.']");
    ...
    public void triggerOtpSend(String mobileNo) {
        if (mobileNo == null || mobileNo.trim().isEmpty()) {
            throw new IllegalArgumentException("❌ Operator mobile number is null or empty. Please check your sheet or test data.");
        }

        ToastMessageHandler toastHandler = new ToastMessageHandler(driver);
        driver.findElement(operatorMobileNumber).sendKeys(mobileNo);
